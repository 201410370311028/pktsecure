...
public class verifikasi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.verifikasi_activity);

        rev = (RecyclerView)findViewById(R.id.verifikasi);
        ...
        navigationDrawerLeft.setOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id, IDrawerItem drawerItem) {
                ...
                switch (position) {
                    case 0:
                        intent = new Intent(verifikasi.this, verifikasi.class);
    ...
    public void button_on_proses(View view) {
        Intent proses = new Intent(verifikasi.this, on_proses.class);
        startActivity(proses);
    }

    public void button_special_key(View view) {
        Intent spesial = new Intent(verifikasi.this, special_case.class);
        startActivity(spesial);
    }

    public void button_verifikasi(View view){
        Intent verifikasi = new Intent(verifikasi.this, verifikasi.class);
        startActivity(verifikasi);
    }

    public void button_closed(View view){
        Intent verifikasi = new Intent(verifikasi.this, close.class);
        startActivity(verifikasi);
    }
...
//        progressDialog.show();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Api.URL_READ_VERIFIKASI_PETUGAS,
                new Response.Listener<String>() {
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            AdapterTindakan = new AdapterOnProses(listTindak, verifikasi.this);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(verifikasi.this, error.getMessage(),Toast.LENGTH_SHORT).show();
            }
        });
