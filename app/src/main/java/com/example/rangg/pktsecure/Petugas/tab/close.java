...
public class close extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.closed_activity);
        ...
        navigationDrawerLeft.setOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id, IDrawerItem drawerItem) {
                ...
                switch (position) {
                    case 0:
                        intent = new Intent(close.this, on_proses.class);
                        startActivity(intent);
                        break;
                    case 1:
                        intent = new Intent(close.this, close.class);
                        startActivity(intent);
                        break;
                    case 2:
                        intent = new Intent(close.this, on_proses.class);
    ...
    public void button_on_proses(View view) {
        Intent proses = new Intent(close.this, on_proses.class);
        startActivity(proses);
    }

    public void button_special_key(View view) {
        Intent spesial = new Intent(close.this, special_case.class);
        startActivity(spesial);
    }

    public void button_verifikasi(View view){
        Intent verifikasi = new Intent(close.this, verifikasi.class);
        startActivity(verifikasi);
    }

    public void button_closed(View view){
        Intent verifikasi = new Intent(close.this, close.class);
        startActivity(verifikasi);
    }
...
//        progressDialog.show();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Api.URL_READ_CLOSED_PETUGAS,
                new Response.Listener<String>() {
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            AdapterTindakan = new AdapterOnProses(listTindak, close.this);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(close.this, error.getMessage(),Toast.LENGTH_SHORT).show();
            }
        });
