...
import com.example.rangg.pktsecure.Adapter.DetailPengaduanAdapter;
...
public class DetailPelaporanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        rev.setLayoutManager(new LinearLayoutManager(DetailPelaporanActivity.this));
        ...
        navigationDrawerLeft.setOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id, IDrawerItem drawerItem) {
                ...
                switch (position) {
                    case 0:
                        intent = new Intent(DetailPelaporanActivity.this, MenuKaryawanActivity.class);
                        startActivity(intent);

                        break;
                    case 1:
                        intent = new Intent(DetailPelaporanActivity.this, HistoryKaryawanActivity.class);
                        startActivity(intent);
                        break;
    ...
    private void loadRecyleriewData() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Api.URL_READ_DETAIL_PENGADUAN,
                new Response.Listener<String>() {
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            adapterreadpengaduan = new DetailPengaduanAdapter(DetailPelaporanActivity.this, readpengaduanmodel);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(DetailPelaporanActivity.this, error.getMessage(),Toast.LENGTH_SHORT).show();
            }
        }){
