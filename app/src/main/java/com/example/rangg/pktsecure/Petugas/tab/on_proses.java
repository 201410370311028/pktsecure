...
public class on_proses extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.on_proses_activity);
        ...
        navigationDrawerLeft.setOnDrawerItemClickListener(new Drawer.OnDrawerItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id, IDrawerItem drawerItem) {
                ...
                switch (position) {
                    case 0:
                        intent = new Intent(on_proses.this, on_proses.class);
    ...
    public void button_on_proses(View view) {
        Intent proses = new Intent(on_proses.this, on_proses.class);
        startActivity(proses);
    }

    public void button_special_key(View view) {
        Intent spesial = new Intent(on_proses.this, special_case.class);
        startActivity(spesial);
    }

    public void button_verifikasi(View view){
        Intent verifikasi = new Intent(on_proses.this, verifikasi.class);
        startActivity(verifikasi);
    }

    public void button_closed(View view){
        Intent verifikasi = new Intent(on_proses.this, close.class);
        startActivity(verifikasi);
    }
...
//        progressDialog.show();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, Api.URL_READ_PENGADUAN_PETUGAS,
                new Response.Listener<String>() {
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            AdapterTindakan = new AdapterOnProses(listTindak, on_proses.this);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(on_proses.this, error.getMessage(),Toast.LENGTH_SHORT).show();
            }
        });
